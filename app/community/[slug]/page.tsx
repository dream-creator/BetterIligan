...
// We ONLY need the communities data now
...
export default function CommunityProfilePage({
    ...
    // Find the community using the slug from the URL
    const community = allServices.find((c) => c.type === "internal" && c.slug === resolvedParams.slug);

    const categoryData = serviceCategories.find(
        (c) => c.name === community?.category || c.slug === community?.category
    );

    // 2. Extract the icon, or use a default fallback (like Briefcase) if the category isn't found
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-8">
                    ...
                    <div className="mb-8">
                        ...
                        {community.offeredServices && community.offeredServices.length > 0 ? (
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {!community.websiteUrl && !community.facebookUrl && !community.instagramUrl && (
